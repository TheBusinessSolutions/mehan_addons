...
class BookingSlot(models.Model):
    ...
    line_ids = fields.Many2many("sale.order.line", 'booking_order_rel', 'order_id', 'book_id', string="Booking Orders", copy=False)
    currency_id = fields.Many2one('res.currency', related='slot_config_id.product_id.currency_id', string="Currency")
