...
//console.log("custom website_product_variant_description caleedddddddddddddddddddddddddddddddddd")
odoo.define('website_product_variant_description.website_product_variant_description', function(require) {
    "use strict";
